...
public class CustomDatePicker {
    ...
    private void monthChange() {
        month.clear();
        int currentSelect = selectedCalender.get(Calendar.MONTH);
        ...
        selectedCalender.set(Calendar.MONTH, Integer.parseInt(month.get(Math.min(currentSelect, month.size() - 1))) - 1);
        month_pv.setData(month);
        month_pv.setSelected(Math.min(currentSelect, month.size() - 1));
    ...
    private void dayChange() {
        day.clear();
        int currentSelect = selectedCalender.get(Calendar.DAY_OF_MONTH) - 1;
        int selectedYear = selectedCalender.get(Calendar.YEAR);
        ...
        selectedCalender.set(Calendar.DAY_OF_MONTH, Integer.parseInt(day.get(Math.min(currentSelect, day.size() - 1))));
        day_pv.setData(day);
        day_pv.setSelected(Math.min(currentSelect, day.size() - 1));
    ...
    private void hourChange() {
        if ((scrollUnits & SCROLL_TYPE.HOUR.value) == SCROLL_TYPE.HOUR.value) {
            hour.clear();
            int currentSelect = selectedCalender.get(Calendar.HOUR_OF_DAY);
            int selectedYear = selectedCalender.get(Calendar.YEAR);
            int selectedMonth = selectedCalender.get(Calendar.MONTH) + 1;
            ...
            selectedCalender.set(Calendar.HOUR_OF_DAY, Integer.parseInt(hour.get(Math.min(currentSelect, hour.size() - 1))));
            hour_pv.setData(hour);
            hour_pv.setSelected(Math.min(currentSelect, hour.size() - 1));
    ...
    private void minuteChange() {
        if ((scrollUnits & SCROLL_TYPE.MINUTE.value) == SCROLL_TYPE.MINUTE.value) {
            minute.clear();
            int currentSelect = selectedCalender.get(Calendar.MINUTE);
            int selectedYear = selectedCalender.get(Calendar.YEAR);
            int selectedMonth = selectedCalender.get(Calendar.MONTH) + 1;
            int selectedDay = selectedCalender.get(Calendar.DAY_OF_MONTH);
            ...
            selectedCalender.set(Calendar.MINUTE, Integer.parseInt(minute.get(Math.min(currentSelect, minute.size() - 1))));
            minute_pv.setData(minute);
            minute_pv.setSelected(Math.min(currentSelect, minute.size() - 1));
