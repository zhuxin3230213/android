...
import cn.gmuni.sc.module.more.market.MarketActivity;
 ...
 * @Author:ZhuXin
 * @Description:
 * @Date:Create 2019/1/8 16:45
 * @Modified By:
 **/
public class MarketFragment extends BaseFragment implements CustomRefreshRecycleView.OnRefreshListener {
    ...
    public void addListItem(MarketModel model) {
        hideEmpty();
        list.add(0, model);
        if(null == multiTypeAdapter){
            multiTypeAdapter = listView.initRefreshRecyclerView(list, getContext());
