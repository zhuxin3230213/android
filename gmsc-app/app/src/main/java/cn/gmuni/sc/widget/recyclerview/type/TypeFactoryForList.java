...
import cn.gmuni.sc.module.more.market.holder.MarketMessageModelViewHolder;
import cn.gmuni.sc.module.more.market.holder.MarketModelViewHolder;
import cn.gmuni.sc.module.more.market.holder.ReMarketMessageModelViewHolder;
...
public class TypeFactoryForList implements TypeFactory {
    ...
    public static final int layoutId_market_item = R.layout.fragment_market_list_view_item;
    public static final int layoutId_market_message_list_view_item = R.layout.market_message_list_view_item;
    public static final int layoutId_re_market_message_list_view_item = R.layout.re_market_message_list_view_item;
    @Override
    ...
    @Override
    public int type(MarketModel marketModel) {
        return layoutId_market_item;
    }

    @Override
    public int type(MarketMessageModel marketMessageModel) {
        return layoutId_market_message_list_view_item;
    }

    @Override
    public int type(ReMarketMessageModel reMarketMessageModel) {
        return layoutId_re_market_message_list_view_item;
    }
    ...
    public BaseViewHolder createViewHolder(int type, View itemView) {
        ...
        } else if (layoutId_market_item == type) {
            return new MarketModelViewHolder(itemView);
        } else if (layoutId_market_message_list_view_item == type) {
            return new MarketMessageModelViewHolder(itemView);
        }else if (layoutId_re_market_message_list_view_item == type){
            return new ReMarketMessageModelViewHolder(itemView);
        }
        return null;
    }
}
