...
public class IndexBar extends LinearLayout {
    private static final String[] INDEXES = new String[]{"常用","1", "A", "B", "C", "D", "E", "F", "G", "H",
    ...
    private void init(AttributeSet attrs) {
        ...
        float indexTextSize = ta.getDimension(R.styleable.IndexBar_indexTextSize, PixelUtil.sp2px(12, getContext()));
        int indexTextColor = ta.getColor(R.styleable.IndexBar_indexTextColor, ColorUtil.hex2Int("#0d2e6b"));
        ta.recycle();
