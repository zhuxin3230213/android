package cn.gmuni.sc.widget.listview;
...
/**
 * @Author:ZhuXin
 * @Description: 自定义下拉刷新与上拉加载更多
 * @Date:Create in 11:43 2018/8/21
 * @Modified By:
 **/
public class CustomRefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.widget_loading_custom_listview, null);
...
*/
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.widget_loading_custom_listview, null);
